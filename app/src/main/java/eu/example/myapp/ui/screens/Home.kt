...
fun HomeScreen(navController: NavController) {
    Column(modifier = Modifier
        ...
        Text(text = "Recomendation", style = MaterialTheme.typography.headlineMedium)
        LazyRow(
            modifier = Modifier
                .fillMaxWidth()
            ...
            items(DummyData.cameralist) { brand ->
        ...
        Text(text = "List Product Camera", style = MaterialTheme.typography.headlineMedium)
        LazyColumn(
            modifier = Modifier
                .fillMaxSize()
                .padding(top = 8.dp)
